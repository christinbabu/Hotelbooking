...
router.post("/", [auth, adminMiddleware, validate(validateRestaurantPassword)], async (req, res) => {
  ...
  // console.log(restaurant,"rp",req.body.oldPassword)
  // let validPassword = await bcrypt.compare(req.body.oldPassword, restaurant.password);
  // if (!validPassword)
